...
AnVIL uses [Terra](https://anvil.terra.bio/) to run analyses.  Terra provides many computational tools useful for biological data analysis, such as [RStudio](), [Galaxy](), and [Jupyter Notebooks]().  Terra takes care of installing these tools on Google's computers, so that you can just start using them.

Make sure you can log in to Terra - you will need to use Terra to perform computations on AnVIL. 
...
Open Terra ([`anvil.terra.bio`](https://anvil.terra.bio/)), and you should be prompted to sign in with your Google account.

**Step 3: Share username**

Finally, make sure your instructor has your Google account username (e.g. `myname@gmail.com`), so they give you access to everything you need.
