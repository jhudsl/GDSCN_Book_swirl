...
1. Locate the Workspace **`r workspace_name`**.  (The images below show the SARS-CoV-2-Genome Workspace as an example, but you should look for the Workspace  **`r workspace_name`**.)
