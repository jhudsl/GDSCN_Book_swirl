...
:::{.reflection}
1. What is the average case count for Hepatitis A in Maryland?
...
1. Now modify the above command to select a different disease and state, and find the average count.
:::
